...
var random_number = quick_draw_data_set[Math.floor((Math.random()*quick_draw_data_set.length)+1)];

console.log(random_number);

var sketch = quick_draw_data_set[random_number];

 var sketch_to_be_drawn=sketch_to_be_drawn+sketch;
...
random_number=quick_draw_data_set[Math.floor((Math.random()*quick_draw_data_set.length)+1)];
console.log(random_number);
console.log(sketch);
}
